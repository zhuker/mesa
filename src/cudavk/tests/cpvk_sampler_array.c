 ...
 *
 *   CUDAVK_SPEC_STATS=1 ... cpvk_sampler_array
 *   cudavk: sampler specialisation: 0/2 fragment launches specialised
 ...
 *
 *   cc -std=c11 -Wall -Wextra -Werror src/cudavk/tests/cpvk_sampler_array.c \

...
def cmd_record(args):
    ...
    if not args.no_diffs:
        ...
        # software rasterization costs; a residual only cudavk has is a
    ...
    # since NVIDIA's output does not change when cudavk does.
...
def main():
    ...
    r.add_argument("--driver", default="cudavk")

...
every state the driver can be in --
  ...
  CUDAVK_FUSED_VFETCH=1       the fused execution for every admitted shader
  ...
  CUDAVK_NO_FUSED_VFETCH=1    the second binary is not even built
...
STATES = [
    ("default", {}),
    ("fused", {"CUDAVK_FUSED_VFETCH": "1"}),
    ("fused+decline1", {"CUDAVK_FUSED_VFETCH": "1",
                        "CUDAVK_VFETCH_DECLINE_NTH": "1"}),
    ("fused+decline2", {"CUDAVK_FUSED_VFETCH": "1",
                        "CUDAVK_VFETCH_DECLINE_NTH": "2"}),
    ("no-fused", {"CUDAVK_NO_FUSED_VFETCH": "1"}),
]

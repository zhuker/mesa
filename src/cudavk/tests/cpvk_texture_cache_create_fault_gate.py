...
base.pop("CUDAVK_NO_TEXTURE_CACHE", None)  # hardware texture path is the default now
base["CUDAVK_TEXTURE_CACHE_STATS"] = "1"

def run(args, stage):
    env = base.copy()
    env["CUDAVK_TEXTURE_CACHE_FAIL_CREATE_STAGE"] = str(stage)

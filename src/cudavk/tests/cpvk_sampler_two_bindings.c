 ...
 *
 *   CUDAVK_SPEC_STATS=1 ... cpvk_sampler_two_bindings
 *   cudavk: sampler specialisation: 0/4 fragment launches specialised
 ...
 *      src/cudavk/tests/cpvk_sampler_two_bindings.c \

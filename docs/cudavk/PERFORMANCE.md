...
| opaque episode gate recorded once | `CUDAVK_NO_EPISODE_GATE_ONCE` | favorite3 6.3535 2192 6.4580 (+0.1045), favorite2 5.1209 2192 5.2393 (+0.1184) | B200: see the 2026-09-02/03 set measurement |
| refusing un-appendable blended batches | `CUDAVK_NO_APPEND_PREFILTER` | favorite3 6.4465 → 6.6881 (+0.2416), favorite2 5.2330 → 5.4685 (+0.2355) | B200: see the 2026-09-02/03 set measurement |
